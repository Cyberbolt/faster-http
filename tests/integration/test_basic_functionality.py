...
class TestBasicIntegration:
    ...
    def test_helper_objects_creation_comparison(self):
        ...
        faster_headers = faster_http.Headers({
            "User-Agent": "test-client",
            "Accept": "application/json"
        })
        ...
        httpx_params = httpx.QueryParams({
            'search': 'python',
            'limit': '10'
        })
        ...
        faster_params = faster_http.QueryParams({
            'search': 'python',
            'limit': '10'
        })
    ...
    def test_client_methods_exist_comparison(self):
        ...
        for method in methods:
            ...
            assert hasattr(faster_async_client, method), f"faster_http AsyncClient missing {method} method that httpx has"
    ...
    def test_error_classes_exist_comparison(self):
        ...
        expected_errors = [
            ...
            'PoolTimeout', 'ProtocolError', 'TooManyRedirects', 'TransportError',
            'StreamError', 'InvalidURL', 'LocalProtocolError', 'RemoteProtocolError',
