...
def sample_cookies():
    ...
    return {"session_id": "abc123", "user_pref": "dark_mode", "lang": "en", "csrf_token": "token123", "theme": "blue"}


@pytest.fixture
def sample_params():
    """Sample query parameters for testing."""
    return {"q": "test query", "page": "1", "limit": "10", "sort": "name", "order": "asc", "filter": "active"}
...
def sample_files():
    ...
    return {"test_file": b"Hello, World!", "data_file": b"Test file content", "config_file": b'{"key": "value"}'}


@pytest.fixture
def sample_multipart_data():
    """Sample multipart form data for testing."""
    return {"files": {"upload": b"file content"}, "data": {"name": "test", "value": "data"}}
