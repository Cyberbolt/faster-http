...
class TestStatusCodes:
    ...
    def test_codes_consistency_comparison(self):
        ...
        httpx_attrs = {attr for attr in dir(httpx_codes) if not attr.startswith("_")}
        faster_attrs = {attr for attr in dir(faster_codes) if not attr.startswith("_")}
        ...
        for code_name in common_codes:
            ...
            assert httpx_value == faster_value, (
                f"Code {code_name} differs: httpx={httpx_value}, faster_http={faster_value}"
            )
