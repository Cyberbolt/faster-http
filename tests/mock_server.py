...
class MockHTTPRequestHandler(BaseHTTPRequestHandler):
    ...
    def _send_json_response(self, status_code: int, data: dict[str, Any], headers: dict[str, str] | None = None):
    ...
    def do_GET(self):
        ...
        if path == "/get":
            ...
            self._send_json_response(status_code, {"status": status_code, "message": f"HTTP {status_code}"})
        elif path == "/redirect":
