...
from ._core import AsyncHttpClient as _AsyncHttpClient, HttpClient as _HttpClient, HttpRequest as _HttpRequest, HttpResponse
...
class Client:
    """Synchronous HTTP client compatible with httpx.Client."""
    ...
    def send(self, request: _HttpRequest) -> HttpResponse:
        """Send a pre-built request."""
