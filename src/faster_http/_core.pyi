...
class HttpResponse:
    ...
    # Streaming methods
    def iter_bytes(self, chunk_size: int | None = None) -> Generator[bytes, None, None]: ...
    def iter_text(self, chunk_size: int | None = None) -> Generator[str, None, None]: ...
    def iter_lines(self) -> Generator[str, None, None]: ...
    def iter_raw(self, chunk_size: int | None = None) -> Generator[bytes, None, None]: ...

    # Async streaming methods
    def aiter_bytes(self, chunk_size: int | None = None) -> AsyncGenerator[bytes, None]: ...
    def aiter_text(self, chunk_size: int | None = None) -> AsyncGenerator[str, None]: ...
...
class MockTransport:
    ...
    def handle_request(self, request: HttpRequest) -> HttpResponse: ...
    def handle_async_request(self, request: HttpRequest) -> Awaitable[HttpResponse]: ...
    def close(self) -> None: ...
    def aclose(self) -> None: ...
    def __enter__(self) -> MockTransport: ...
    def __exit__(self, exc_type: Any, exc_value: Any, traceback: Any) -> None: ...
    def __aenter__(self) -> Awaitable[MockTransport]: ...
    def __aexit__(self, exc_type: Any, exc_value: Any, traceback: Any) -> Awaitable[None]: ...
